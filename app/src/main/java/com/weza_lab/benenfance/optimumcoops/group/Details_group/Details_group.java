...
public class Details_group extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent.hasExtra("gUname")) {
            gUname = intent.getStringExtra("gUname");
        } else gUname = "";
        ...
        mViewPager.getViewPager().setAdapter(new FragmentStatePagerAdapter(getSupportFragmentManager()) {
            ...
            public Fragment getItem(int position) {
                switch (position % 1) {
                    case 0: {
                        Fragment f = new DetailsGroupRecyclerViewFrgmnt();
                ...
                switch (page) {
                    case 0:
                        ...
                        return HeaderDesign.fromColorResAndDrawable(
                                R.color.blue, getResources().getDrawable(R.drawable.group), getResources().getDrawable(R.drawable.ic_create_black_24dp));
