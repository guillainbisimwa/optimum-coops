...
public class Credit {
    ...
    public Credit(int id_credit, long timestamp, String hash, String previous_hash, int nonce, float somme_credit, String phone_user_credit, int type_user_credit, int etat_credit, float taux_credit, String motif_credit, int duree) {
