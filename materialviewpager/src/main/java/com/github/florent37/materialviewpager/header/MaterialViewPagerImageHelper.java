...
public class MaterialViewPagerImageHelper {
    ...
    public static void setImageDrawable_fab(final FloatingActionButton floatingActionButton, final Drawable drawable, final int fadeDuration) {
        final float alpha = ViewCompat.getAlpha(floatingActionButton);
        final FloatingActionButton viewToAnimate = floatingActionButton;
