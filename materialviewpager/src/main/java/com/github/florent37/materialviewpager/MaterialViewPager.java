...
public class MaterialViewPager extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    //a view used to add  color over the fab
    ...
    public void setImageDrawable_fab(Drawable drawable, int fadeDuration) {
        if (drawable != null) {
            final FloatingActionButton floatingActionButton = (FloatingActionButton) findViewById(R.id.fab);
            //if using MaterialViewPagerImageHeader
            if (floatingActionButton != null) {
                ViewCompat.setAlpha(floatingActionButton, settings.headerAlpha);
                MaterialViewPagerImageHelper.setImageDrawable_fab(floatingActionButton, drawable, fadeDuration);
                setImageHeaderDarkLayerAlpha();
            }
        }
    }
    ...
    public void onPageSelected(int position) {
        ...
        if (headerDesign.getDrawable_fab() != null) {
            setImageDrawable_fab(headerDesign.getDrawable_fab(), fadeDuration);
        } else {
            setImageUrl(headerDesign.getImageUrl(), fadeDuration);
        }
    ...
    protected void onFinishInflate() {
        ...
        if (!isInEditMode()) {
            materialViewPagerHeader = MaterialViewPagerHeader
                    ...
                    .withFloatingActionButton(floatingActionButton);
